    ...
    static int fluidSpriteIndex(int kind) {
        ...
        synchronized (VssLodSpriteTable.class) {
            ...
            ResourceLocation id = switch (kind) {
                case 1 -> new ResourceLocation("minecraft", "block/water_still");
                case 2 -> new ResourceLocation("minecraft", "block/lava_still");
                default -> new ResourceLocation("minecraft", "block/ice");
            };
            try {
        ...
        try {
            ...
            if (PredictionVegetation.fire(state)) {
                ...
                var sprite = Minecraft.getInstance().getModelManager().getAtlas(TextureAtlas.LOCATION_BLOCKS)
                        .getSprite(new ResourceLocation("minecraft", soul ? "block/soul_fire_0" : "block/fire_0"));
