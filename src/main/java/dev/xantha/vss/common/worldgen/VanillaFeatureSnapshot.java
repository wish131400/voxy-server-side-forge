...
/** Preserve effective runtime values which the 1.20.1 vanilla codec encodes incorrectly. */
public final class VanillaFeatureSnapshot {
    ...
    private static final class CornerField {
        ...
        private static Field find() {
            try {
                Field field;
                try { field = CherryFoliagePlacer.class.getDeclaredField("cornerHoleChance"); }
                catch (NoSuchFieldException production) {
                    field = CherryFoliagePlacer.class.getDeclaredField("f_271392_");
                }
                field.setAccessible(true);
                return field;
            } catch (ReflectiveOperationException exception) {
                throw new IllegalStateException("Minecraft 1.20.1 cherry foliage field unavailable", exception);
            }
        }
    }
}
