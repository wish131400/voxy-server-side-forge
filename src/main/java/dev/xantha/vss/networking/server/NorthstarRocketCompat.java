...
public final class NorthstarRocketCompat {
    ...
    private static void syncRocket(ServerPlayer viewer, ServerPlayer target, Entity rocket) {
        if (isVanillaTracking(viewer, rocket)) {
            ...
            if (viewerStates != null && viewerStates.remove(rocket.getId()) != null) {
    ...
    private static boolean sendPairingData(ServerPlayer viewer, Entity rocket) {
        ...
        try {
            ...
            serverEntity.sendPairingData(viewer, packets::add);
    ...
    private static void sendNorthstarSync(ServerPlayer viewer, Entity rocket) {
        ...
        try {
            ...
            resolved.channelSendMethod.invoke(
                    resolved.getChannelMethod.invoke(null),
    ...
    private static Reflection reflection() {
        ...
        try {
            ...
            Constructor<?> syncPacketConstructor = syncPacketClass.getConstructor(
                    int.class,
                    Vec3.class,
                    float.class,
                    int.class,
            ...
            Method getChannelMethod = packetsClass.getMethod("getChannel");
            Method channelSendMethod = SimpleChannel.class.getMethod(
                    "send",
                    PacketDistributor.PacketTarget.class,
                    Object.class);
